...
- 경사 하강법(Update): 역전파로 계산된 기울기를 경사 하강법(또는 Adam 등 옵티마이저) 수식에 넣어 가중치를 실제 업데이트합니다. <br/> 순전파와 역전파는 경사 하강법을 작동시키는 데 필요한 핵심 입력값을 제공하며, 딥러닝 학습의 1회 반복(Iteration)을 구성합니다.
